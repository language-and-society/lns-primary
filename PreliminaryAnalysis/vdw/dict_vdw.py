...
with open('vdw.txt', 'r', encoding="utf8") as f:
...
def get_type(sentence):
    if ("INT"  in sentence) or ("EXT" in sentence) or ':' in sentence or '-' in sentence or '–' in sentence or '(' in sentence or ')' in sentence or 'TH' in sentence or '!' in sentence or '.' in sentence or '?' in sentence or 'DAY' in sentence:
        return 1
...
with open("vdw_character_data.json", 'w') as f:
