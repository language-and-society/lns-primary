...
with open('queen.txt', 'r', encoding="utf8") as f:
...
def get_type(sentence):
    if ("INT"  in sentence) or ("EXT" in sentence) or ("I/E." in sentence) or sentence[0: len(sentence)-1].isdecimal() or sentence[-1] == ")" or sentence[-1] == ":" or sentence[-1] == "!":
        return 1
...
def clean_sentence(sentence):
    try:
        return (sentence[0:sentence.index('(')-1])
    except:
        return sentence
...
with open("queen_character_data.json", 'w') as f:
